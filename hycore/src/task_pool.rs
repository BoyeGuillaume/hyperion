...
use bevy_tasks::{TaskPoolBuilder, prelude::*, tick_global_task_pools_on_main_thread};
use std::sync::Arc;

use crate::{instance::plugin::Plugin, schedule::Last};
...
impl Plugin for TaskPoolPlugin {
    fn init(
        ...
        task_pool_options.create_default_pools();

        // System that ticks the global task pools each frame
        instance.add_systems(Last, tick_global_task_pools);
...
impl std::fmt::Debug for TaskPoolThreadAssignmentPolicy {
